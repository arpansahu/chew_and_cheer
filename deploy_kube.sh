...
LOCAL_IMAGE="chew_and_cheer"
TAG="latest"
NAMESPACE="default"
SECRET_NAME="chew-and-cheer-secret"
ENV_FILE=".env"
...
function set_default_variables {
    IMAGE_NAME="chew_and_cheer"
    KUBE_DEPLOYMENT="chew-and-cheer-app"
    DEPLOYMENT_FILE="deployment.yaml"
}

# Function to set mac specific variables
function set_mac_variables {
    IMAGE_NAME="chew_and_cheer_mac"
    KUBE_DEPLOYMENT="chew-and-cheer-mac-app"
